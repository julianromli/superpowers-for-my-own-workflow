...
> **Note:** This document is adapted from Anthropic's official Claude Code documentation. 
> References to "Claude" apply to any AI agent using these skills, including Factory Droid.
> Original source: https://docs.anthropic.com/en/docs/agents-and-tools/agent-skills/skill-authoring-best-practices
