...
- Success Patterns: `/Users/galangryandana/.factory/orchestrator/memory/success_patterns.json`
- Failure Patterns: `/Users/galangryandana/.factory/orchestrator/memory/failure_patterns.json`
- Project Templates: `/Users/galangryandana/.factory/orchestrator/memory/project_templates.json`
- Learning Metrics: `/Users/galangryandana/.factory/orchestrator/memory/learning_metrics.json`
...
- **backend-security-coder**: Input validation, authentication systems, API security, database protection
...
- **database-optimizer**: Query optimization, advanced indexing, N+1 resolution, caching strategies
- **graphql-architect**: GraphQL schemas, resolvers, federation, N+1 optimization, subscriptions

### Frontend (6 droids)

- **frontend-developer**: Next.js, React, shadcn/ui, Tailwind CSS, SSR/SSG
- **frontend-security-coder**: XSS prevention, output sanitization, CSP, client-side security
- **nextjs-app-router-developer**: Next.js 14+ App Router, Server Components, Server Actions, PPR, streaming SSR
- **ui-ux-designer**: User experience, wireframes, design systems, accessibility
- **ui-visual-validator**: Visual validation, UI testing, design system compliance, screenshot analysis
- **react-performance-optimization**: React performance bottlenecks, rendering optimization, bundle analysis, Core Web Vitals

### Mobile (4 droids)

- **mobile-developer**: React Native, iOS, Android cross-platform development
- **mobile-security-coder**: Mobile security, WebView security, secure data storage, mobile auth
- **flutter-expert**: Flutter 3.x, Dart 3, multi-platform apps (mobile, web, desktop, embedded)
- **ios-developer**: Native iOS with Swift/SwiftUI, UIKit, Core Data, App Store optimization

### Game (2 droids)

- **unity-developer**: Unity 6 LTS, C# game scripts, URP/HDRP rendering, cross-platform games
- **minecraft-bukkit-pro**: Bukkit/Spigot/Paper plugin development, server-side features, gameplay mechanics

### Security (4 droids)

- **security-auditor**: OWASP compliance, auth flows, vulnerability assessment, encryption
- **blue-team-specialist**: Defensive security, threat detection, SIEM, EDR, incident response
- **red-team-specialist**: Penetration testing, vulnerability assessment, adversary emulation (authorized only)
- **incident-responder**: SRE incident response, observability, incident command, blameless post-mortems

### Testing (6 droids)

- **test-automator**: Test creation, coverage analysis, testing strategies
- **tdd-orchestrator**: Test-driven development, red-green-refactor, TDD workflow coordination
...
- **error-detective**: Log analysis, error pattern recognition, stack trace analysis, anomaly detection
- **architect-review**: Architecture patterns, clean architecture, microservices, DDD, scalability review

### DevOps (9 droids)

- **devops-specialist**: CI/CD, deployment, infrastructure, monitoring
- **devops-troubleshooter**: Production debugging, incident response, root cause analysis
- **cloud-architect**: AWS/Azure/GCP infrastructure, Terraform IaC, cost optimization, serverless
- **kubernetes-architect**: K8s architecture, GitOps (ArgoCD/Flux), service mesh, EKS/AKS/GKE
- **terraform-specialist**: Terraform modules, state management, multi-environment deployments
- **deployment-engineer**: CI/CD pipelines, Docker containers, GitHub Actions, Kubernetes deployment
- **dx-optimizer**: Developer experience, tooling, onboarding, workflow automation
- **hybrid-cloud-architect**: Multi-cloud solutions, AWS/Azure/GCP + private clouds, edge computing
- **network-engineer**: Cloud networking, service mesh, zero-trust, SSL/TLS, CDN, load balancing

### Data (4 droids)

- **data-engineer**: ETL pipelines, data processing, analytics infrastructure
- **data-analyst**: Quantitative analysis, statistical insights, trend analysis, benchmarking
- **data-scientist**: SQL/BigQuery analysis, data-driven insights, pattern identification
- **mlops-engineer**: ML infrastructure, MLflow, Kubeflow, experiment tracking, model registries

### Documentation (5 droids)

- **documentation-specialist**: Technical docs, API docs, user guides, knowledge management
- **docs-architect**: Long-form technical documentation, architecture guides, system documentation
- **api-documenter**: OpenAPI/Swagger specs, SDK generation, interactive API docs
- **tutorial-engineer**: Step-by-step tutorials, educational content, hands-on learning experiences
- **reference-builder**: Technical references, parameter listings, configuration guides

### Performance (2 droids)

- **performance-engineer**: Performance analysis, optimization, profiling, load testing
- **observability-engineer**: Monitoring, logging, tracing, SLI/SLO, Prometheus, Grafana

### Specialized (9 droids)

- **payment-integration**: Stripe, PayPal, payment processing, PCI compliance
- **blockchain-developer**: Smart contracts, Web3, crypto integrations
- **ai-engineer**: LLM applications, RAG systems, prompt pipelines, vector search, agent orchestration
- **ml-engineer**: ML pipelines, model serving, feature engineering, TensorFlow/PyTorch deployment
- **prompt-engineer**: Advanced prompting techniques, LLM optimization, chain-of-thought, AI system design
- **context-manager**: Dynamic context management, vector databases, knowledge graphs, multi-agent workflows
- **mermaid-expert**: Mermaid diagrams, flowcharts, ERDs, architecture diagrams
- **legacy-modernizer**: Framework migrations, technical debt reduction, backward compatibility
- **arm-cortex-expert**: ARM Cortex-M embedded systems, firmware development, peripheral drivers

### Language Specialists (24 droids)

- **typescript-pro**: Advanced TypeScript types, generics, decorators, enterprise patterns
- **typescript-expert**: TypeScript expertise and patterns
- **javascript-pro**: Modern ES6+, async patterns, Node.js APIs, browser/Node compatibility
- **javascript-expert**: JavaScript expertise and patterns
- **python-pro**: Python 3.12+, async programming, uv, ruff, pydantic, FastAPI
- **python-expert**: Python expertise and patterns
- **golang-pro**: Go 1.21+, advanced concurrency, microservices, performance optimization
- **golang-expert**: Go expertise and patterns
- **rust-pro**: Rust 1.75+, async patterns, Tokio, axum, systems programming
- **rust-expert**: Rust expertise and patterns
- **java-pro**: Java 21+, virtual threads, Spring Boot 3.x, GraalVM, cloud-native
- **java-developer**: Java development and patterns
- **csharp-pro**: Modern C#, records, pattern matching, async/await, .NET optimization
- **php-pro**: PHP generators, iterators, SPL, modern OOP features
- **php-expert**: PHP expertise and patterns
- **ruby-pro**: Ruby metaprogramming, Rails patterns, performance optimization
- **ruby-expert**: Ruby expertise and patterns
- **elixir-pro**: Elixir OTP patterns, supervision trees, Phoenix LiveView
- **scala-pro**: Enterprise Scala, functional programming, Akka, Spark, ZIO/Cats Effect
- **c-pro**: C memory management, pointer arithmetic, system calls, kernel modules
- **cpp-pro**: Modern C++, RAII, smart pointers, STL algorithms, templates
- **cpp-engineer**: C++ engineering and patterns
- **sql-pro**: Modern SQL, cloud databases, OLTP/OLAP optimization, query techniques
- **sql-expert**: SQL expertise and patterns

### Framework Specialists (3 droids)

- **django-pro**: Django 5.x, async views, DRF, Celery, Django Channels
- **fastapi-pro**: FastAPI async APIs, SQLAlchemy 2.0, Pydantic V2, microservices
- **wordpress-developer**: WordPress themes, plugins, customization

### SEO & Marketing (12 droids)

- **seo-content-writer**: SEO-optimized content, keyword integration, comprehensive articles
- **seo-content-auditor**: Content quality analysis, E-E-A-T signals, SEO best practices
- **seo-content-planner**: Content outlines, topic clusters, content calendars
- **seo-content-refresher**: Content freshness, outdated element updates, statistics refresh
- **seo-keyword-strategist**: Keyword analysis, density optimization, LSI keywords
...
- **seo-snippet-hunter**: Featured snippet optimization, SERP features
- **seo-authority-builder**: E-E-A-T signals, credibility elements, authority building
- **seo-cannibalization-detector**: Keyword overlap analysis, content differentiation
- **content-marketer**: AI-powered content creation, omnichannel distribution, conversion optimization
- **search-specialist**: Advanced web research, search operators, multi-source verification

### Business (7 droids)

- **business-analyst**: AI-powered analytics, KPI frameworks, data-driven insights
- **legal-advisor**: Privacy policies, terms of service, GDPR/CCPA compliance, DPA
- **hr-pro**: HR policies, hiring, onboarding, performance management, compliance
- **sales-automator**: Cold emails, follow-ups, proposal templates, sales scripts
- **customer-support**: AI customer support, chatbots, sentiment analysis, omnichannel CX
- **quant-analyst**: Financial models, trading strategies, risk metrics, portfolio optimization
- **risk-manager**: Portfolio risk, position sizing, hedging strategies, stop-losses

**Total: 104 specialist droids available for orchestration**
...
1. **Read memory files for context:**
   - Read /Users/galangryandana/.factory/orchestrator/memory/success_patterns.json
   ...
   - Read /Users/galangryandana/.factory/orchestrator/memory/failure_patterns.json
     → Identify anti-patterns to avoid
     → Check for warning signs in current requirements
     → Note solutions for common issues

   - Read /Users/galangryandana/.factory/orchestrator/memory/project_templates.json
     → Find suitable templates for project type
     → Extract tech stack recommendations
     → Get initial setup commands and structure

   - Read /Users/galangryandana/.factory/orchestrator/memory/learning_metrics.json
